...
from llm_library.nn_components.ffn import FeedForwardNetwork, silu
...
def run_embedding(
    ...
    embedding_layer.load_state_dict({"embedding_table":weights})
...
def run_rmsnorm(
    ...
    rmsnorm = RMSNorm(d_model, eps, impl="default")
